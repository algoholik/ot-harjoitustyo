...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_kortilla_voi_ostaa_edullisen_lounaan_kun_kortilla_tasan_edullisen_hinta(self):
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
        # nyt kortin saldo on tasan edullisen hinta 2.5
        self.kortti.syo_edullisesti()
        self.assertEqual(str(self.kortti), "Kortilla on rahaa 0.0 euroa")

    def test_kortilla_voi_ostaa_maukkaan_lounaan_kun_kortilla_tasan_maukkaan_hinta(self):
        self.kortti.lataa_rahaa(2)
        self.kortti.syo_maukkaasti()
        self.kortti.syo_maukkaasti()
        # nyt kortin saldo on tasan maukkaan hinta 4
        self.kortti.syo_maukkaasti()
