...
class TestSnip(unittest.TestCase):
    def setUp(self):
        ...
        self.testsnip = Snip(123, 0, "Snip content", self.timetest)
    ...
    def test_snip_returns_sniptype_correctly(self):
        self.assertEqual(self.testsnip.get_sniptype(), 0)

    def test_snip_returns_content_correctly(self):
        self.assertEqual(self.testsnip.get_content(), "Snip content")

    def test_snip_returns_modified_correctly(self):
    ...
    def test_snip_sets_sniptype_correctly(self):
        self.testsnip.set_sniptype(1)
        self.assertEqual(self.testsnip.get_sniptype(), 1)
    ...
    def test_snip_sets_modified_correctly(self):
        self.timetest2 = datetime.now()
        self.testsnip.set_modified(self.timetest2)
        self.assertEqual(self.testsnip.get_modified(), self.timetest2)
